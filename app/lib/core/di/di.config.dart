...
import 'package:core_dependency/core_dependency.dart' as _i3;
...
import '../controller/controller_hub.dart' as _i4;
...
Future<_i1.GetIt> $initGetIt(
  ...
  await gh.lazySingletonAsync<_i3.Brightness>(
    () => registerModule.brightness,
    preResolve: true,
  );
  gh.singleton<_i4.ControllerHub>(_i4.ControllerHubImpl(
    get<_i5.AppRouter>(),
    get<_i3.EventBus>(),
    get<_i6.HomeFeature>(),
