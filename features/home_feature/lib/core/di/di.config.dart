...
import '../../src/domain/use_case/cache_homes_use_case.dart' as _i12;
import '../../src/domain/use_case/fetch_home_use_case.dart' as _i13;
import '../../src/domain/use_case/get_homes_cached_use_case.dart' as _i14;
import '../../src/presentation/controllers/banner/banner_controller.dart'
    as _i3;
import '../../src/presentation/controllers/home/home_controller.dart' as _i15;
...
_i1.GetIt $initGetIt(
  ...
  gh.singleton<_i12.CacheTasksUseCase>(
      _i12.CacheTasksUseCase(get<_i10.HomeRepository>()));
  gh.singleton<_i13.FetchTasksUseCase>(
      _i13.FetchTasksUseCase(get<_i10.HomeRepository>()));
  gh.singleton<_i14.GetTasksCachedUseCase>(
      _i14.GetTasksCachedUseCase(get<_i10.HomeRepository>()));
  gh.factory<_i15.HomeController>(() => _i15.HomeControllerImpl(
        get<_i12.CacheTasksUseCase>(),
        get<_i13.FetchTasksUseCase>(),
        get<_i14.GetTasksCachedUseCase>(),
      ));
  return get;
}
