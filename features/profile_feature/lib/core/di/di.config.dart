...
import '../../src/data/profile/profile_repository.dart' as _i9;
import '../../src/data/profile/profile_service.dart' as _i6;
import '../../src/data/profile/remote_data_source.dart' as _i8;
...
_i1.GetIt $initGetIt(
  ...
  gh.singleton<_i8.ProfileRemoteDataSource>(
      _i8.ProfileRemoteDataSource(get<_i6.ProfileService>()));
  gh.singleton<_i9.ProfileRepository>(_i9.ProfileRepository(
    get<_i8.ProfileRemoteDataSource>(),
    get<_i10.LocalDataSource>(),
    get<_i5.ProfileModelConverter>(),
  ));
  gh.factory<_i11.ProfileController>(
      () => _i11.ProfileControllerImpl(get<_i9.ProfileRepository>()));
  return get;
}
