...
import 'package:core_data_source/core_data_source.dart' as _i7;
...
import '../../src/data/home/home_service.dart' as _i8;
import '../../src/data/home/remote_data_source.dart' as _i6;
...
_i1.GetIt $initGetIt(
  ...
  gh.singleton<_i5.HomeRepository>(_i5.HomeRepository(
    get<_i6.HomeRemoteDataSource>(),
    get<_i7.LocalDataSource>(),
    get<_i4.HomeModelConverter>(),
  ));
  gh.singleton<_i8.HomeService>(_i8.HomeService(get<_i9.Dio>()));
  gh.singleton<_i7.RemoteDataSource<_i8.HomeService>>(
      _i6.HomeRemoteDataSource(get<_i8.HomeService>()));
  gh.factory<_i10.HomeController>(
      () => _i10.HomeControllerImpl(get<_i5.HomeRepository>()));
  return get;
}
